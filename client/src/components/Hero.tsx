...
const Hero = () => {
  return (
    <section className="flex flex-col md:flex-row lg:flex-row items-center justify-center min-h-screen overflow-hidden">
      <Illustration />
      <div className="flex flex-col justify-center items-center md:items-start w-[70vw] text-center md:text-center lg:text-left">
        ...
        <Link href="/signup">
          <Button className="w-auto px-6 py-3 bg-[#D08726] text-white my-4">Get Started!</Button>
        </Link>
      </div>
