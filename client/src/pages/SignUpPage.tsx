          ...
          <div className="max-w-3xl mx-auto">
            ...
            <form className="space-y-4 p-2" onSubmit={handleSubmit}>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="firstName" className="block text-1xl font-medium text-primary">
                    First Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="lastName" className="block text-1xl font-medium text-primary">
                    Last Name
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-1xl font-medium text-primary">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="phoneNumber" className="block text-1xl font-medium text-primary">
              ...
              <div>
                <label htmlFor="password" className="block text-1xl font-medium text-primary">
                  Password
                </label>
                <input
                  type="password"
